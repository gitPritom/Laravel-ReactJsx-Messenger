            ...
            {attachments.length > 0 && (
                <div className="mt-2 flex flex-wrap justify-end gap-1">
                    {attachments.map((attachment, ind) => (
                        <div onClick={(e) => attachmentClick(attachments, ind)}
                            key={attachment.id}
                    ...
                    text-gray-500 relative cursor-pointer` +
                            ...
                            cursor-pointner hover:bg-gray-800 "
                                >
                                    <ArraowDownTrayIcon className="w-4 h-4" />
                                </a>
                            )}
                            ...
                            {isVideo(attachment) && (
                                ...
                                text-white opacity-70" />
                                    <div className="absolute left-0 w-full h-full bg-black/50 z-10">
                                    </div>
