...
const ConversationItem = ({
    ...
    return (
            <Link href={conversation.is_group
                ...
                preserveState className={
                    "conversation-item flex items-center gap-2 p-2 text-gray-300 transition-all cursor-pointer hover:bh-black/30 border-l-4 "
                    + classes +
            ...
            >
                ...
                <div
                    ...
                    <div className="flex gap-1 justify-content items-center">
                        <h3 className="tect-sm font-semibold overflow-hidden text-nowrap text-ellipsis">
                            {conversation.name}
                        </h3>
